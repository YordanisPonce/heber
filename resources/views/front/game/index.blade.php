...
<head>
    ...
    <title>Configuración Ejercicios</title>
...
<body>
    ...
    <div class="containter-fluid" id="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-4">
                        <select class="form-control" id="operationSelected">
                            ...
                            <option id="multiplication" value="multiplicacion" <?php if (session()->
                                has('id_task')) {
                            ...
                            <option id="traditionalDivision" value="divisionTradicional" <?php if
                                (session()->has('id_task')) {
                                echo $o->operation == 'divisionTradicional' ? 'selected' : '';
                                } ?>>División Tradicional</option>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-4">
                        <div class="form-group">
                            <input type="number" class="form-control" placeholder="Número de páginas" value="<?php if (session()->has('id_task')) {
                                echo $o->pages;
        ...
        <div class="row justify-content-center" style="margin-top: 30px;">
            <div class="col-auto ">
                <button type="button" class="btn btn-lg btn-warning button" style="width: 250px;"
                    id="create">Iniciar</button>
